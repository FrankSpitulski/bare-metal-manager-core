...
use dpu::DpuConfig;
use forge_secrets::credentials::{CredentialManager, Credentials, TestCredentialManager};
use forge_secrets::static_credentials::StaticCredentialSnapshot;
...
pub async fn create_test_env_with_overrides(
    ...
    let static_credential_reader: Arc<
        dyn forge_secrets::static_credentials::StaticCredentialReader,
    > = Arc::new(test_static_credential_snapshot());
...
fn test_static_credential_snapshot() -> StaticCredentialSnapshot {
    StaticCredentialSnapshot {
        dpu_redfish_factory_default: Some(Credentials::UsernamePassword {
            username: "root".to_string(),
            password: "dpuredfish_dpuhardwaredefault".to_string(),
        }),
        dpu_redfish_site_default: Some(Credentials::UsernamePassword {
            username: "root".to_string(),
            password: "dpuredfish_sitedefault".to_string(),
        }),
        host_redfish_site_default: Some(Credentials::UsernamePassword {
            username: "root".to_string(),
